...
def test_transmissionSTARTSTOP_preparation(t1_SERVER,det,IP,PORT,t2_SERVER,t3_SERVER):
    os.chdir(os.path.dirname(os.path.abspath(__file__)))
    FILENAME = "transmissionSTARTSTOP_log.txt"

    nameOfReport = "Отчет о результатах выполнения автотеста 5.3.2.70 Transmission control using START/STOP\n"
